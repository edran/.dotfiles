...
(defun dotspacemacs/user-config ()
  ...
  (setq global-rainbow-identifiers-mode t)
  ...
  (setq org-capture-templates
        '(("l" "Lab-related TODO tasks" entry
           (file "lab.org")
           "* TODO %?\nSCHEDULED: %t")
          ("L" "Lab-related TODO deadline" entry
           (file "lab.org")
           "* TODO %?\nDEADLINE: %t")
          ("h" "Home related TODO tasks" entry
           (file "home.org")
           "* TODO %?\nSCHEDULED: %t")
          ("H" "Home related TODO deadline" entry
           (file "home.org")
           "* TODO %?\nDEADLINE: %t")
          ("n" "A standard note" entry
           (file+headline "notes.org" "Other")
           "* %?\n%T"
           :empty-lines 1)
          ("r" "Research note" entry
           (file+headline "notes.org" "Research")
           "* %?\n%T"
           :empty-lines 1)
          ("R" "Paper review" entry
           (file "reviews.org")
           "* %?\n%T"
           :empty-lines 1)))
