...
To setup capture on MacOS, I had to save the following script as =org-capture.app=
...
Then I had to add this to =Info.plist= inside =org-capture.app=:
...
Afterwards one can for instance use some javascript to make a bookmark as follows:
